-- Fix accept_offer function to include all required columns for repayment_schedules
-- The original function was missing principal_minor and interest_minor columns
