-- Update cancel function to also mark the offer as withdrawn
-- This way the lender sees the offer is no longer active
...
BEGIN
  ...
  -- Mark the accepted offer as withdrawn so lender sees it's cancelled
  -- Use 'withdrawn' because 'cancelled' is not a valid offer_status enum value
  ...
  BEGIN
    INSERT INTO public.notifications (
      ...
      'The borrower has cancelled the loan before signing. Your offer has been withdrawn.',
      'loan',
      p_loan_id,
      NOW()
    );
