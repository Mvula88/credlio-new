...
export default function LenderNotificationsPage() {
  ...
  const notificationTypes = [
    ...
    { value: 'loan_defaulted', label: 'Loan Defaulted' },
    { value: 'payment_received', label: 'Payment Received' },
    { value: 'payment_overdue', label: 'Payment Overdue' },
    { value: 'agreement_signed_borrower', label: 'Agreement Signed' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Track your lending activities and borrower communications
          </p>
        </div>
        {unreadCount > 0 && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Payment Alerts</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2">
              <TrendingUp className="h-5 w-5 text-green-600" />
              <span className="text-2xl font-bold text-green-600">
                {notifications.filter(n => n.type.startsWith('payment_')).length}
              </span>
            </div>
          </CardContent>
        </Card>
      ...
      <Alert>
        ...
        <AlertDescription>
          Notifications are automatically cleared after 30 days. Payment and risk alerts are preserved for compliance records.
        </AlertDescription>
      </Alert>
    </div>
  )
