-- Update auto_verify_borrower to mark selfie as uploaded
-- This ensures the middleware can properly check verification status
...
BEGIN
  ...
  SET
    ...
    duplicate_of = CASE WHEN v_duplicate.is_duplicate THEN
      ...
      ELSE NULL
    END,
    selfie_uploaded = v_has_selfie,  -- Mark selfie as uploaded if document exists
