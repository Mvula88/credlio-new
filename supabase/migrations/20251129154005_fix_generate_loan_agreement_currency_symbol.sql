-- Fix generate_loan_agreement function to use country_currency_allowed table for currency symbol
-- The countries table does NOT have currency_symbol column - it's in country_currency_allowed
