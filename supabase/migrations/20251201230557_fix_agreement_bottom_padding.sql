-- Fix agreement HTML to add bottom padding for PDF footer watermark
-- The Credlio watermark was overlapping with the IMPORTANT box
...
'Generates a professional loan agreement with clear interest breakdown. Added bottom padding to prevent overlap with PDF footer watermark.';
