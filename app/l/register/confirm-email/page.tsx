    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/lender" className="inline-flex items-center space-x-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                <p>After confirming, you can sign in and complete your lender profile</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
          ...
          <CardFooter className="flex flex-col space-y-3">
            <Button asChild className="w-full">
              <Link href="/l/login">Go to Sign In</Link>
            </Button>
            <p className="text-sm text-center text-gray-500">
              Already confirmed?{' '}
              <Link href="/l/login" className="text-blue-600 hover:text-blue-700 font-medium">
                Sign in here
              </Link>
            </p>
          </CardFooter>
