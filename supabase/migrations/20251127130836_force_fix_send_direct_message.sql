-- Force fix send_direct_message function - use business_name instead of full_name
-- The lenders table does not have a full_name column
...
BEGIN
  ...
  -- Use business_name only (lenders table has NO full_name column)
