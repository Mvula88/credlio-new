-- Fix accept_offer function to use SIMPLE INTEREST calculation
-- Simple interest: Total Interest = Principal × Rate%
-- The apr_bps already contains the TOTAL rate (base + extra for term)
-- So we should NOT divide by 12 or factor in term again
...
BEGIN
  ...
  -- Example: 1500 bps = 15%, so 1000 * 1500 / 10000 = 150
